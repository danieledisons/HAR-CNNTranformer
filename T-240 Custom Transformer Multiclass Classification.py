...
with torch.no_grad(): #Making sure that we don't update the gradient outside the training part
        ...
        Preds_prob, Preds, Targets = EvalPredict(model, batch_size, device, X_Test, Y_Test)
...
SaveFolder = f"{path_root}/Models/T-240 Valid Loss 0.79 Acc 0.71, Test Acc 0.71 AUC 0.95 F1 0.71"
